...
Click [here](https://medium.com/@ismailjavababatundephantware/how-the-web-process-client-request-dd915234813f) to read my article.

### Task 1
Add a schema to your blog post illustrating the flow of the request created when you type https://alx-intranet.hbtn.io/ in your browser and press Enter.\
